...
# Convertir x et y map en longitude et latitude 
# Définir le transformateur pour la conversion Lambert 93 (EPSG:2154) -> WGS84 (EPSG:4326)
transformer = Transformer.from_crs("EPSG:3950", "EPSG:4326", always_xy=True)

# Effectuer la conversion des coordonnées
